...
export const LINKS = {
  ...
  resellerGroupFallback: "https://t.me/+Iex1rHLSF6hmNzU1", // contoh: "https://chat.whatsapp.com/XXXXX"
};
...
export const PRODUCTS = [
  {
    ...
    plans: [
      ...
      { key: "panel-3gb", label: "3GB", ramGb: 3, cores: null, price: 4000, badge: "Plus" },
      { key: "panel-4gb", label: "4GB", ramGb: 4, cores: null, price: 5000, badge: "Popular" },
...

  {
    ...
    plans: [
      { key: "vps-1c-2g", label: "1 Core / 2GB", ramGb: 2, cores: 1, price: 15000, badge: "SG" }, // 2g1
      ...
      { key: "vps-4c-8g", label: "4 Core / 8GB", ramGb: 8, cores: 4, price: 25000, badge: "SG" }, // 8g4
      { key: "vps-4c-16g", label: "4 Core / 16GB", ramGb: 16, cores: 4, price: 45000, badge: "SG" }, // 16g4
      { key: "vps-8c-16g", label: "8 Core / 16GB", ramGb: 16, cores: 8, price: 55000, badge: "SG" }, // 16g8
    ],
    notes: [
...

  {
    ...
    requires: { name: true, hostname: false },
    plans: [
      { key: "admin-access", label: "Admin Access", ramGb: null, cores: null, price: 20000, badge: "Admin" },
    ],
    notes: [
